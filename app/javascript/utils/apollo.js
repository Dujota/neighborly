...
/**
 * In production, it makes more sense to use an exception tracking service (e.g., Sentry or Honeybadger):
 *
 * just override the logError function to send errors to the external system
 */
